                    ...
                    <Menubar className="border-none bg-transparent shadow-none h-auto p-0">
                        <MenubarMenu>
                            ...
                            <MenubarContent className="print:hidden">
                                <MenubarSub>
                                    ...
                                    <MenubarSubContent>
                                        <MenubarItem onClick={onSaveJSON}>
                                            <FileJsonIcon className="size-r mr-2"/> 
                                            JSON
                                        </MenubarItem>
                                        <MenubarItem onClick={onSaveHTML}>
                                            <GlobeIcon className="size-r mr-2"/> 
                                            HTML
                                        </MenubarItem>
                                        <MenubarItem onClick={()=>window.print()}>
                                            <BsFilePdf className="size-r mr-2"/> 
                                            PDF
                                        </MenubarItem>
                                        <MenubarItem onClick={onSaveText}>
                                            <FileTextIcon className="size-r mr-2"/> 
                                            Text
                                        </MenubarItem>
                                    </MenubarSubContent>
                                </MenubarSub>
                                <MenubarItem onClick={onNewDocument}>
                                    <FilePlusIcon className="size-r mr-2"/>
                                    New Document
                                </MenubarItem>
                                <MenubarSeparator/>
                                ...
                                >
                                    <FilePenIcon className="size-r mr-2"/>
                                    Rename
                                </MenubarItem>
                                </RenameDialog>
                                <RemoveDialog documentId={data._id}>
                                    <MenubarItem
                                        ...
                                        onSubmit={(e) => e.preventDefault()}
                                    >
                                    <TrashIcon className="size-r mr-2"/>
                                    Remove
                                    </MenubarItem>
                                </RemoveDialog>
                                <MenubarSeparator />
                                <MenubarItem onClick={()=> window.print()}>
                                    <PrinterIcon className="size-r mr-2"/>
                        ...
                        <MenubarMenu>
                            ...
                            <MenubarItem onClick={() => editor?.chain().focus().undo().run()}>
                                ...
                                Undu <MenubarShortcut>Ctrl + Z </MenubarShortcut>
                            </MenubarItem>
                                ...
                                <MenubarSub>
                                    ...
                                    <MenubarSubContent>
                                        ...
                                        <MenubarItem onClick={() => editor?.chain().focus().toggleItalic().run()}>
                                            ...
                                            Itallic <MenubarShortcut>Ctrl + I </MenubarShortcut>
                                        </MenubarItem>
